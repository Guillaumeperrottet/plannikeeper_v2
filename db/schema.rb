...
ActiveRecord::Schema[7.1].define(version: 2025_04_16_191449) do
  ...
  create_table "tasks", force: :cascade do |t|
    ...
    t.date "recurrence_reminder_date"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "company_id"
    t.boolean "can_manage_tasks"
    t.boolean "can_view_reports"
  ...
  add_foreign_key "objets", "companies"
  add_foreign_key "objets", "users"
